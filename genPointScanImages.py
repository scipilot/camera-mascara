...
S =  9 # size of square that is scanned. NOTE: this should be proportional to the resolution, else it's darker at higher res. An odd number is better for gaussian.
...
# Good settings (so the dark boundary is the "width" specified):
#                       128+9:1.75, 128+15:3, 128+33:5, 128+65:12
#                        64+9:2,     64+15:3,  64+33:3
